/*!\file setparityuart1.c
 * \brief Implementation file for configuring parity for UART1 Device.
 *
 *  This file contains implementation for configuring the parity for UART1
...
UCHAR setparity_UART1( UCHAR parity )
{
	...
	U1CTL0 = (U1CTL0&~(UART_CTL0_PEN|UART_CTL0_PSEL)) | (parity<<3) ;
	

	return UART_ERR_NONE ;
	
}//! end of setparity_UART1()
