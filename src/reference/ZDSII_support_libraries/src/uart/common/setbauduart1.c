/*!\file setbauduart1.c
 * \brief Implementation file for configuring baudrate for UART1 Device.
 *
 *  This file contains implementation for configuring the baudrate for UART1
...
//	brgval = ( g_clock1 ) / ( CLOCK_DIVISOR * baud ) ;						//! Compute the baudrate generator value.
	brgval = ( g_clock1 + (baud*8UL) ) / ( CLOCK_DIVISOR * baud ) ;			//! with round-off.
