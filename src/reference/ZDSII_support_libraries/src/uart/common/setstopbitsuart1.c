/*!\file setstopbitsuart1.c
 * \brief Implementation file for configuring stopbits for UART1 Device.
 *
 *  This file contains implementation for configuring the stopbits for UART1
...
UCHAR setstopbits_UART1( UCHAR stopbits )
{
	...
	U1CTL0 = (U1CTL0&~UART_CTL0_STOP) | ((stopbits-(BYTE)1)<<1) ;
	

	return UART_ERR_NONE ;
	
}//! end of setstopbits_UART1()
