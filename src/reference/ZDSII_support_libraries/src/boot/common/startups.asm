...
;
 IF	INITSP
	LDX     SPL,#low(_near_stack+1)
	LDX     SPH,#high(_near_stack+1)
 ENDIF
;
...
; Set the .FRAME directive for RDATA last; this will place the _0_exit symbol
; in RDATA & prevent CR 13514 for CPUs that lack EDATA
