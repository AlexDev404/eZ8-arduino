/*!\file setmodeinterrupt8pinporta.c
 ...
 *
 *
 * setmodeInterrupt_PortA_8Pn( PORTPIN_ONE ) ;
 *
 * setmodeInterrupt_PortA_8Pn( PORTPIN_FIVE|PORTPIN_SEVEN ) ;
 *
...
}//! end of setmodeInterrupt_PortA_8Pn()
