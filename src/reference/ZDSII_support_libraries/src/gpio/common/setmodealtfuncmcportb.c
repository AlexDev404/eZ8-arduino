...
CHAR setmodeAltFunc_PortB( UCHAR pins )
{
	...
	PBADDR = PORTADDR_ALTFUNC0 ;		//!< Get access to Alternate Function 0 register.
	RESETBIT( PBCTL, pins ) ;			//!< Reset bits corresponding to pins in Alternate Function register.
