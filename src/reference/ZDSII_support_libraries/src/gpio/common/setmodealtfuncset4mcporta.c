/*!\file setmodealtfuncset4mcporta.c
 * \brief Implementation file for setting Alternate Function Set-4 mode for Port A bits.
 *
...
/*!
 * @{
 * Set Alternate Function Set-4 mode for Port A.
 *
 * This API can be used to configure one or more pins of Port A to alternate function set-4
 ...
 *
 * As an example to set Pin 1 of Port A into alternate function set-4 mode, call this API by
...
CHAR setmodeAltFuncSet4_PortA( UCHAR pins )
{
	...
	PAADDR = PORTADDR_ALTFUNC1 ;	//!< Get access to Alternate Function 1 register.
	SETBIT( PACTL, pins ) ;			//!< Set bits corresponding to pins in Alternate Function 1 register.
...
}//! end of setmodeAltFuncSet4_PortA()
