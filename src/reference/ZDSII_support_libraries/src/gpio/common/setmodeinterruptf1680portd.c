/*!\file setmodeinterruptf1680portd.c
 ...
 *
 *
 * setmodeInterrupt_PortD_F1680( PORTPIN_ONE ) ;
 *
 * setmodeInterrupt_PortD_F1680( PORTPIN_FIVE|PORTPIN_SEVEN ) ;
 *
...
}//! end of setmodeInterrupt_PortD_F1680()
