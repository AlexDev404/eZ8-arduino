/*!\file setmodealtfuncset2porta.c
 * \brief Implementation file for setting Alternate Function Set-2 mode for Port A bits.
 *
...
/*!
 * @{
 * Set Alternate Function Set-2 mode for Port A.
 *
 * This API can be used to configure one or more pins of Port A to alternate function set-2
 ...
 *
 * As an example to set Pin 1 of Port A into alternate function set-2 mode, call this API by
...
CHAR setmodeAltFuncSet2_PortA( UCHAR pins )
{
	...
	RESETBIT( PACTL, pins ) ;			//!< Reset bits corresponding to pins in Alternate Function Set-1 register.
...
}//! end of setmodeAltFuncSet2_PortA()
