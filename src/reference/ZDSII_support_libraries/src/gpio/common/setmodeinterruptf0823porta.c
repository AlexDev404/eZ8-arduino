/*!\file setmodeinterruptf0823porta.c
 ...
 *
 *
 * setmodeInterrupt_PortA_F0823( PORTPIN_ONE ) ;
 *
 * setmodeInterrupt_PortA_F0823( PORTPIN_FIVE|PORTPIN_SEVEN ) ;
 *
...
}//! end of setmodeInterrupt_PortA_F0823()
