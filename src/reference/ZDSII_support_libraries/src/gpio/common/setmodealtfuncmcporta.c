...
CHAR setmodeAltFunc_PortA( UCHAR pins )
{
	...
	PAADDR = PORTADDR_ALTFUNC0 ;	//!< Get access to Alternate Function 0 register.
	RESETBIT( PACTL, pins ) ;		//!< Reset bits corresponding to pins in Alternate Function 0 register.
