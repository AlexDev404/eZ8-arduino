...
/*******************************************************************************
 *                ENVSPRINTF.C  built from template file VSPRINTF.TPL
...
*************************************************/
#undef e_n_vsprintf
PF_REENTRANT int e_n_vsprintf(char pageE * string,__CONST__ char near * fmt,va_list args)
{
...
#define PRNT_FMT_ARG &print_fmt,
  ...
  _u_n_print(PRNT_FMT_ARG fmt, args);
