...
/*******************************************************************************
 *                ERBSEARCH.C  built from template file BSEARCH.TPL
...
*************************************************/
#undef e_bsearch
void rom * e_r_bsearch(__CONST__ void pageE * key,
			      __CONST__ void rom * base,
			      size_t num,
			      size_t span,
			      reentrant int (*comp)(__CONST__ void pageE *, __CONST__ void rom *))
{
  unsigned int mid;
  unsigned int low;
  unsigned int high;
