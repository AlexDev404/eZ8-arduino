...
/*******************************************************************************
 *                FEBSEARCH.C  built from template file BSEARCH.TPL
...
*************************************************/
#undef f_bsearch
void pageE * f_e_bsearch(__CONST__ void far * key,
			      __CONST__ void pageE * base,
			      size_t num,
			      size_t span,
			      reentrant int (*comp)(__CONST__ void far *, __CONST__ void pageE *))
{
  unsigned int mid;
  unsigned int low;
  unsigned int high;
