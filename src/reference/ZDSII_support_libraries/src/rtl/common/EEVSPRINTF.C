...
/*******************************************************************************
 *                EEVSPRINTF.C  built from template file VSPRINTF.TPL
...
*************************************************/
#undef e_e_vsprintf
PF_REENTRANT int e_e_vsprintf(char pageE * string,__CONST__ char pageE * fmt,va_list args)
{
...
#define PRNT_FMT_ARG &print_fmt,
  ...
  _u_e_print(PRNT_FMT_ARG fmt, args);
