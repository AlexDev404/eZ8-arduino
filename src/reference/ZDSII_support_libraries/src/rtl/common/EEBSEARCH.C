...
/*******************************************************************************
 *                EEBSEARCH.C  built from template file BSEARCH.TPL
...
*************************************************/
#undef e_bsearch
void pageE * e_e_bsearch(__CONST__ void pageE * key,
			      __CONST__ void pageE * base,
			      size_t num,
			      size_t span,
			      reentrant int (*comp)(__CONST__ void pageE *, __CONST__ void pageE *))
{
  unsigned int mid;
  unsigned int low;
  unsigned int high;
  ...
  for(;;) {
    ...
    d = (*comp)(key,addr = (char pageE *)base + (size_t)(mid * span));
