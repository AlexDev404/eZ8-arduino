...
/*******************************************************************************
 *                EFBSEARCH.C  built from template file BSEARCH.TPL
...
*************************************************/
#undef e_bsearch
void far * e_f_bsearch(__CONST__ void pageE * key,
			      __CONST__ void far * base,
			      size_t num,
			      size_t span,
			      reentrant int (*comp)(__CONST__ void pageE *, __CONST__ void far *))
{
  unsigned int mid;
  unsigned int low;
  unsigned int high;
  ...
  for(;;) {
    ...
    d = (*comp)(key,addr = (char far *)base + (size_t)(mid * span));
