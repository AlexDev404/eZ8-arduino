...
/*******************************************************************************
 *                NNBSEARCH.C  built from template file BSEARCH.TPL
...
*************************************************/
#undef n_bsearch
void near * n_n_bsearch(__CONST__ void near * key,
			      __CONST__ void near * base,
			      size_t num,
			      size_t span,
			      reentrant int (*comp)(__CONST__ void near *, __CONST__ void near *))
{
  unsigned int mid;
  unsigned int low;
  unsigned int high;
