...
/*******************************************************************************
 *                EFVSPRINTF.C  built from template file VSPRINTF.TPL
...
*************************************************/
#undef e_f_vsprintf
PF_REENTRANT int e_f_vsprintf(char pageE * string,__CONST__ char far * fmt,va_list args)
{
...
#define PRNT_FMT_ARG &print_fmt,
  ...
  _u_f_print(PRNT_FMT_ARG fmt, args);
