...
/*******************************************************************************
 *                FNUSCAN.C  built from template file USCAN.TPL
...
/*					*/
/****************************************/
static unsigned char _u_f_charset(struct fmt_type *print_fmt)
{
  near char * p2;
  char neg,ch;
  char * p = NULL;
...
/*					*/
/****************************************/
static unsigned char _u_f_scalar(struct fmt_type *print_fmt, int radix)
{
  unsigned char i;
  char ch;
...
/*					*/
/****************************************/
static unsigned char _u_f_fpoint(struct fmt_type *print_fmt)
{
  unsigned char i;
  char ch;
  char far * bp = _u_fmt_buf;
...
/*					*/
/****************************************/
static unsigned char _u_f_character(struct fmt_type *print_fmt)
{
  unsigned char i;
  char ch;
  char * p = NULL;
...
/*					*/
/****************************************/
static unsigned char _u_f_string(struct fmt_type *print_fmt)
{
  unsigned char i;
  char ch;
  char * p = NULL;
...
/*					*/
/****************************************/
static unsigned char _u_f_pointer(struct fmt_type *print_fmt)
{
  unsigned char i;
  char ch;
  char far * bp = _u_fmt_buf;
...
int _u_f_n_scan(__CONST__ char far * src,__CONST__  char near * fmt, va_list ap)
{
  ...
  while ( ok && /*_u_prev_ch!=EOF &&*/ *fmt) {
    ...
    if (print_ctrl.status == FMT_ERR)
	  ...
	  case 'i':
	  case 'u':
                ok = _u_f_scalar(&print_fmt, 10);
		break;
	  case 'x':
	  case 'X':
                ok = _u_f_scalar(&print_fmt, 16);
		break;
	  case 'o':
                ok = _u_f_scalar(&print_fmt, 8);
		break;
	  case 'A':
	  case 'E':
	  case 'F':
	  ...
	  case 'f':
	  case 'g':
                ok = _u_f_fpoint(&print_fmt);
		break;
	  case 'c':
		ok = _u_f_character(&print_fmt);
		break;
	  case 's':
		ok = _u_f_string(&print_fmt);
		break;
	  case 'p':
		ok = _u_f_pointer(&print_fmt);
		break;
	  case 'n':
