...
/*******************************************************************************
 *                NEBSEARCH.C  built from template file BSEARCH.TPL
...
*************************************************/
#undef n_bsearch
void pageE * n_e_bsearch(__CONST__ void near * key,
			      __CONST__ void pageE * base,
			      size_t num,
			      size_t span,
			      reentrant int (*comp)(__CONST__ void near *, __CONST__ void pageE *))
{
  unsigned int mid;
  unsigned int low;
  unsigned int high;
